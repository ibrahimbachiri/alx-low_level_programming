 ...
 * Description: Display information from the ELF header of an ELF file.
 */
 ...
 *
 * Description: This function prints the operating system/ABI of the ELF header.
 */
void print_osabi(unsigned char *e_ident)
{
		printf("  OS/ABI:");
 ...
 *
 * Description: This function closes an ELF file. If the file cannot be closed,
 *              exit code 98 is used.
 */
void close_elf(int elf)
{
		if (close(elf) == -1)
...
/**
 * main - Entry point. Displays information from ELF header of a given ELF file.
